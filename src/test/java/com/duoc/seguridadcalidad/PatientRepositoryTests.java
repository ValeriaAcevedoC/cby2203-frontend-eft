...
class PatientRepositoryTests {
    ...
    private static final String PET_TYPE = "Labrador";
    ...
    void saveShouldAssignIdWhenPatientHasNoId() {
        Patient patient = new Patient(null, "Rex", "dog", PET_TYPE, 3, "John");
    ...
    void saveShouldAssignSequentialIdsToMultiplePatients() {
        Patient p1 = repository.save(new Patient(null, "Rex", "dog", PET_TYPE, 3, "John"));
    ...
    void saveShouldNotOverwriteExistingId() {
        Patient patient = new Patient(99L, "Rex", "dog", PET_TYPE, 3, "John");
        Patient saved = repository.save(patient);
    ...
    void saveShouldAddPatientToRepository() {
        repository.save(new Patient(null, "Rex", "dog", PET_TYPE, 3, "John"));
